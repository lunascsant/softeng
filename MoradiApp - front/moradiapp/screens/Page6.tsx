...
export default function HomeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Republicas Convidadas</Text>

        {/* Moradia 02 (Navegação para a página 5) */}
        <TouchableOpacity
          style={styles.moradiaCard}
          onPress={() => navigation.navigate('Page7')} // Navegação para a Página 5
        >
          <View style={styles.cardHeader}>
            <MaterialIcons name="home" size={30} color="#F5A623" />
      ...
      <TouchableOpacity style={styles.createGroupButton}>
        <Text style={styles.createGroupButtonText}>Entrar em novo grupo como Morador Convidado</Text>
      </TouchableOpacity>
    </View>
  );
}
